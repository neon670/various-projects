...
//updating best score array
function updateBestScore(){
  bestScoreArray.forEach((score, i) => {
    if(questionAmount == score.questions){
      const getSavedBestScore = Number(bestScoreArray[i].bestScore);
...
function checkTime(){
  ...
  if(playerGuessArray.length == questionAmount){
    console.log('guesstrue',  playerGuessArray);
    clearInterval(timer);
...
function createEquations() {
  ...
  console.log('corret', correctEquations)
...
startForm.addEventListener('click', ()=>{
    radioContainers.forEach((radioEl) => {
        ...
        // if radio is checked add it back
